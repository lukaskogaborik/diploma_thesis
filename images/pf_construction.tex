\begin{tikzpicture}[auto]
    ...
    (d3) edge[bend left] node[sloped, below] {\small $2n$} (d4)
    (d0) edge[ultra thick, bend right] node[sloped, below] {\small $1$} (d4)
    (d0) edge[ultra thick] node[sloped, below] {\small $1$} (d5)
    (d6) edge[ultra thick] node[sloped, below] {\small $1$} (d1)
    (d7) edge node[sloped, above] {\small $2n+1$} (d2)
    (d3) edge[ultra thick] node[sloped, above] {\small $0$} (d8)
    (d4) edge[ultra thick] node[sloped, above] {\small $2n+1$} (d9)
